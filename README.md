...
- 🇮🇳 **Live OpenStreetMap Autocomplete** – Integrates Nominatim API for instantaneous, precise city search suggestions restricted to India.
...
| Domain | Technologies |
| :--- | :--- |
| **Frontend** | HTML5, CSS3 (Glassmorphism, Bento Grids, CSS Variables), Vanilla JS, Bootstrap 5 |
